 ...
 * @version 1.1
 * @date 06/05/2011
 * @new Now allows the extraction of dynamic themes
 * @new .vag files can now be converted to .wav
...
class Element
{
    ...
    /**
     * Add a attribute
     * @param P3TAttribute $attr The attribute
     */
     ...
     * This will recursively call all subelements' dump_files() function too.
    ...
    public function dump_files( $rootdir, $hfile, $echo, $save = true )
    {
        ...
        foreach ( $this->elemap as $subele => $info ) {
            $support = $this->elemap[$subele]->dump_files( $rootdir, $hfile, $echo, $save );
